  ...
  factory: (require) => {
    ...
    function HostForm(props) {
      ...
      return react.createElement(
        ...
        react.createElement("label", { className: "dmr-label" }, "密钥路径"),
        react.createElement("input", { className: "dmk-workdir", value: form.keyPath, onChange: set("keyPath"), placeholder: "如 ~/.ssh/id_rsa（可选）" }),
        // Tunnel section
        react.createElement(
          "label",
