    ...
    function HostForm(props) {
      ...
      return react.createElement(
        ...
        react.createElement(
          ...
          react.createElement("div", { className: "dmr-meta" }, "输入远程主机密码，自动将公钥添加到 authorized_keys"),
          react.createElement("input", {
            type: "password",
            className: "dmk-workdir",
            value: form.password,
            onChange: set("password"),
            placeholder: "远程主机密码（可选，留空则用已有密钥尝试）",
            autoComplete: "off"
          }),
          react.createElement("button", { type: "button", className: "dmr-btn dmr-btn-primary", disabled: pushBusy || !form.hostName || !form.user, onClick: onPushKey }, pushBusy ? "推送中..." : "推送公钥"),
